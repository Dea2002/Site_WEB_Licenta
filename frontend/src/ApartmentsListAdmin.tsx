                    ...
                    <div key={apartment._id} className="apartment-card">
                        ...
                        <div className="status-selector">
                            ...
                            <select
                                ...
                                onChange={(e) => {
                                    const newStatus = e.target.value as 'disponibil' | 'indisponibil';
                                    if (newStatus === 'disponibil') {
                                        ...
                                        handleStatusChange(apartment._id, newStatus, apartment.reason || '');
                                    }
                                }}
                            >
                        ...
                        {apartment.status === 'indisponibil' && (
                            <div className="reason-input">
                                ...
                                <input
                                    ...
                                    onKeyPress={(e) => {
                                        if (e.key === 'Enter') {
                                            handleStatusChange(apartment._id, apartment.status, apartment.reason || '');
                                        }
                                    }}
                                />
                            </div>
