...
const Reservation: React.FC = () => {
    ...
    useEffect(() => {
        if (state && state.apartmentId) {
            axios.get<Apartment>(`http://localhost:5000/apartments/${state.apartmentId}`)
                .then(response => {
    ...
    const handleReservation = () => {
        ...
        if (state && state.apartmentId) {
            ...
            axios.post('http://localhost:5000/reserve', { apartmentId: state.apartmentId }, {
                headers: {
    ...
    return (
        <div>
            ...
            <div className="reservation-details">
                ...
                <button onClick={handleReservation} className="button">Rezerva acum</button>
            </div>
